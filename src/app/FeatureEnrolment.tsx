            ...
            <div className="grid items-center gap-14 lg:grid-cols-[1.05fr_0.95fr] lg:gap-20">
              ...
              >
                <MediaPlaceholder
                  ...
                  aspect="aspect-[4/3]"
                  src="/assets/features/enrolment/edbuddies-enrolment-dashboard.png"
                  className="scale-150"
                />
              </motion.div>
            </div>
          ...
          <div className="mx-auto grid max-w-6xl items-center gap-14 lg:grid-cols-2 lg:gap-20">
            ...
            <Reveal delay={0.3} energetic>
              <MediaPlaceholder
                ...
                src="/assets/features/enrolment/edbuddies-enrolment-student-profile.png"
                className="scale-125"
              />
            </Reveal>
          </div>
          ...
          <div className="mx-auto grid max-w-6xl items-center gap-14 lg:grid-cols-2 lg:gap-20">
            ...
            <Reveal delay={0.3} energetic className="lg:order-1">
              <MediaPlaceholder
                ...
                aspect="aspect-square"
                src="/assets/features/enrolment/edbuddies-enrolment-class-placement.png"
                className="scale-125"
              />
            </Reveal>
          </div>
          ...
          <div className="mx-auto max-w-6xl">
            ...
            <Reveal delay={0.4} energetic className="mt-14">
              <MediaPlaceholder
                ...
                aspect="aspect-[8/5]"
                src="/assets/features/enrolment/edbuddies-enrolment-workflow.png"
                className="scale-110"
              />
            </Reveal>
          </div>
